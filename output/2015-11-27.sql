...
select date'2015-11-27' dt, flat_id, building, floor, height, rooms, square, price from (
...
select '1-1' flat_id, 1 building, 3 floor, 32 height, '3комн.' rooms, 79.41 square, 8966400 price from dual union all
select '1-7' flat_id, 1 building, 4 floor, 32 height, '3комн.' rooms, 79.41 square, 8970900 price from dual union all
select '1-13' flat_id, 1 building, 5 floor, 32 height, '3комн.' rooms, 79.41 square, 8975400 price from dual union all
select '1-31' flat_id, 1 building, 8 floor, 32 height, '3комн.' rooms, 79.41 square, 9167900 price from dual union all
...
select '2-56' flat_id, 2 building, 9 floor, 32 height, '2комн.' rooms, 68.64 square, 8173900 price from dual union all
...
select '4-58' flat_id, 4 building, 10 floor, 23 height, '3комн.' rooms, 88.21 square, 10198800 price from dual union all
...
select '5-48' flat_id, 5 building, 8 floor, 23 height, '2комн.' rooms, 61.15 square, 7175000 price from dual union all
select '5-171' flat_id, 5 building, 23 floor, 23 height, '1комн.' rooms, 41.65 square, 7243600 price from dual union all
select '5-1' flat_id, 5 building, 3 floor, 23 height, '2комн.' rooms, 62.48 square, 7348700 price from dual union all
